...
ActiveRecord::Schema.define(version: 2019_03_09_012914) do
  ...
  create_table "shop_databases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "shop_name"
    t.text "introduction"
    t.string "address"
    t.string "tel_number"
